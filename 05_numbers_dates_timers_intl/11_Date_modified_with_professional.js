...
const account2 = {
  ...
  movementsDates: [
    ...
    "2022-08-16T14:43:26.374Z",
    "2022-08-18T18:49:59.371Z",
    "2022-08-19T12:01:20.894Z",
  ],
  currency: "USD",
  locale: "en-US",
};
...
const calcFormatedDays = function (date) {
...
const displayMovements = function (acc, sort = false) {
  ...
  movs.forEach(function (mov, i) {
    ...
    const present = new Date(acc.movementsDates[i]);
    const days = calcFormatedDays(present);
...
btnLogin.addEventListener("click", function (e) {
  ...
  if (currentAccount?.pin === Number(inputLoginPin.value)) {
    ...
    const date = `${present.getDate()}`.padStart(2, 0);
